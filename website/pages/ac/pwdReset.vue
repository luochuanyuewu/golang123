      ...
      <div id="reset" class="golang-forget-form">
        <Row class="golang-forget-form">
          <div v-if="!success">
            ...
            <div
              v-if="luosimaoSiteKey"
              style="min-height: 44px;margin-bottom:22px;"
            >
              <div
                class="l-captcha"
                data-width="400"
          ...
          <div v-if="success">
            <p class="forget-success-icon">
              <img src="~assets/images/round_check_fill.png" alt="" />
            </p>
            <p class="forget-success-info">
              验证邮件已发送至您的邮箱，请注意查收!
            </p>
            <p class="forget-success-info">
              没收到邮件？<span v-if="times > 0">{{ times }}秒后</span
              ><span
                :class="times > 0 ? 'not-resend' : 'forget-resend'"
                @click="reSend"
                >重新发送</span
              >
            </p>
