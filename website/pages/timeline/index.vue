      ...
      <div>
        <ul>
          <li v-for="(item, index) in list">
            <div
              v-if="index == 0 || list[index].year != list[index - 1].year"
              class="timeline-item"
            >
            ...
            <div class="timeline-item">
              <div class="timeline-item-content">
                ...
                <div
                  class="timeline-item-bubble"
                  :class="[
                    index % 2 == 0
                      ? 'timeline-item-bubble-even'
                      : 'timeline-item-bubble-odd'
                  ]"
                >
                  <p class="timeline-item-title">{{ item.name }}</p>
                  <p class="timeline-item-time">
                    <Icon type="ios-clock-outline"></Icon
                    ><span class="timeline-item-time-text">{{
      ...
      list: [
        {
          ...
          content:
            '1.web框架切换到gin<br/>2.登录验证由session改为jwt<br/>3.使用dep来管理第三方包依赖'
        },
        {
          name: '回复功能',
          date: {
        ...
        },
        {
          ...
          content:
            '对拿不准的功能, 会定期在&nbsp;<a href="/vote" target="_blank">投票专栏</a>&nbsp;发起投票, 征求大家的意见'
        },
        {
          name: '架构调整，支持前后端同构渲染',
          date: {
        ...
        },
        {
          ...
          content:
            '代码地址: <a href="https://github.com/shen100/golang123" target="_blank">https://github.com/shen100/golang123</a>'
        }
      ]
    }
  },
