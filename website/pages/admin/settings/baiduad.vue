    ...
    <Form ref="adForm" :model="formData" :rules="formRule" :label-width="120">
      <FormItem label="横幅1(760x90)" prop="banner760x90">
        <Row>
          <Col span="12">
            <Input
              v-model.trim="formData.banner760x90"
      ...
      <FormItem label="横幅2(760x90)" prop="banner2_760x90">
        <Row>
          <Col span="12">
            <Input
              v-model.trim="formData.banner2_760x90"
              placeholder="请输入代码位ID"
            ></Input>
          </Col>
        </Row>
      ...
      <FormItem label="横幅3(760x90)" prop="banner3_760x90">
        <Row>
          <Col span="12">
            <Input
              v-model.trim="formData.banner3_760x90"
              placeholder="请输入代码位ID"
            ></Input>
          </Col>
        </Row>
      ...
      <FormItem label="矩形(250x250)" prop="ad250x250">
        <Row>
          <Col span="12">
            <Input
              v-model.trim="formData.ad250x250"
              placeholder="请输入代码位ID"
            ></Input>
          </Col>
        </Row>
      ...
      <FormItem label="其他(120x90)" prop="ad120x90">
        <Row>
          <Col span="12">
            <Input
              v-model.trim="formData.ad120x90"
              placeholder="请输入代码位ID"
            ></Input>
          </Col>
        </Row>
