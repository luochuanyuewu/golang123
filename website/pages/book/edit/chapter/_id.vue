    ...
    <div class="book-chapter-box">
      <div>
        <div class="book-chapter-tree-box">
          <div class="book-name-edit-box">
            <div v-if="!isEditBookName">
              ...
              <ButtonGroup shape="circle" class="book-name-btngroup">
                <Button
                  @click="onEditBookNameClick"
                  type="primary"
                  icon="edit"
                  size="small"
                ></Button>
                <Button
                  @click="onPublishBookClick"
                  type="primary"
                  icon="android-upload"
                  size="small"
                ></Button>
          ...
          <div
            class="book-chapter-tree"
            :style="{ padding: treeData.length ? '' : '12px 0 12px 20px' }"
          >
            <Tree
              v-if="isMounted"
              :data="treeData"
          ...
          >
            ...
            <Row style="margin-top: 14px;" type="flex" justify="space-between">
              <Button
                type="ghost"
                style="width:48%"
                @click="cancelCreateChapter"
                >取消</Button
              >
              <Button type="primary" style="width:48%" @click="onCreateChapter"
                >确定</Button
              >
            </Row>
            <div slot="footer"></div>
          ...
          <Modal
            v-model="editChapterNameModalVisible"
            title="修改章节名称"
            @on-cancel="cancelEditChapterName"
          >
            <Input
              v-model="tempChapterName"
              placeholder="章节名称"
              size="large"
            />
            <Row style="margin-top: 14px;" type="flex" justify="space-between">
        ...
        <div class="book-chapter-editor">
          <h2 class="curchapter-name">
            {{ curChapter ? '正在编辑: ' + curChapter.title : '暂无章节' }}
          </h2>
          ...
          <div>
            <Button
              ...
              v-if="isMounted"
              type="primary"
              @click="onSaveChapterContent"
              >保存</Button
            >
            <span
              v-if="contentType === 'html'"
              @click="showCrawlModal"
              class="crawl-btn"
              >抓取内容</span
            >
          </div>
        ...
        >
            ...
            >
              <FormItem label="内容选择器" prop="contentSelector">
                <Row>
                  <Col span="12">
                    <Input
                      v-model="crawlerFormData.contentSelector"
          ...
          <Row style="margin-top: 14px;" type="flex" justify="space-between">
            <Button type="ghost" style="width:48%" @click="cancelCrawl"
              >取消</Button
            >
            <Button type="primary" style="width:48%" @click="onCrawl"
              >确定</Button
            >
          </Row>
          <div slot="footer"></div>
...
export default {
            ...
            [
              ...
              h(
                'span',
                {
                  style: {
                    color:
                      this.curChapter && data.id === this.curChapter.id
                        ? '#348eed'
                        : '#333'
                  }
                },
  ...
  head() {
    return {
      title: '编辑章节',
      link: [{ rel: 'stylesheet', href: '/styles/editor/simplemde.min.css' }]
    }
  },
  layout: 'nosidebar',
