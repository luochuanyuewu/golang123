  ...
  <div>
    <div class="golang-home-body">
      <div class="golang-main-top">
        <div
          class="mine-img-box"
          :style="{ 'background-image': 'url(' + currentUser.coverURL + ')' }"
        ></div>
        <div class="mine-info-container">
          ...
          <p class="mine-info-line mine-info-item">
            <span
              class="mine-info-value"
              :class="currentUser.sex == 1 ? 'women' : 'male'"
              ><Icon type="male"></Icon
              >{{ currentUser.sex == 1 ? '女' : '男' }}</span
            >
          </p>
          <p class="mine-info-line mine-info-item">
            <span class="mine-info-desc text-italic">{{
      ...
      <div class="golang-mine-content">
        <div class="mine-content-left">
          <ul class="mine-menu-list">
            <li class="mine-menu-item" style="padding-left: 0;">
              <a
                :class="{ 'mine-menu-item-active': isUserTopicMenu }"
                :href="`/user/${currentUser.id}`"
                >话题<span class="mine-menu-meta">{{
                  currentUser.articleCount
                }}</span></a
              >
            </li>
            <li class="mine-menu-item">
              <a
                :class="{ 'mine-menu-item-active': isUserReplyMenu }"
                :href="`/user/${currentUser.id}/reply`"
                >回复<span class="mine-menu-meta">{{
            ...
            <li class="mine-menu-item">
              <a
                :class="{ 'mine-menu-item-active': isBookMenu }"
                :href="`/user/${currentUser.id}/book`"
                >图书<span class="mine-menu-meta"></span
              ></a>
            </li>
            <li class="mine-menu-item">
              <a
                :class="{ 'mine-menu-item-active': isUserVoteMenu }"
                :href="`/user/${currentUser.id}/vote`"
                >参与的投票<span></span
              ></a>
            </li>
            <li class="mine-menu-item">
              <a
                :class="{ 'mine-menu-item-active': isUserCollectMenu }"
                :href="`/user/${currentUser.id}/collect`"
                >收藏<span class="mine-menu-meta"></span
              ></a>
            </li>
          </ul>
          ...
          <div class="mine-attention-box">
            <div class="attention-item right-border">
              ...
              >
                ...
                <p class="attention-item-num" style="margin-bottom:0;">
                  {{ currentUser.articleCount }}
                </p>
              </a>
            </div>
