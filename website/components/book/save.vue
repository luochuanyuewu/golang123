        ...
        <div class="book-area">
          ...
          >
            ...
            <Form-item label="选择分类" prop="selectedCategory">
              <Select
                v-model="formValidate.selectedCategory"
                style="width: 400px"
              >
                <Option
                  :key="item.id"
                  v-for="item in formValidate.categories"
                  :value="item.id + ''"
                  >{{ item.name }}</Option
                >
              </Select>
            ...
            <Form-item label="图书简介" prop="content">
              <div
                v-show="formValidate.contentType === 'html'"
                class="chapter-html-editor"
              >
                <html-editor
              ...
              <md-editor
                v-show="formValidate.contentType === 'markdown'"
                :value="formValidate.content"
                :user="user"
                @save="onContentSave"
                @change="onContentChange"
  ...
  data() {
    ...
    return {
      ...
      formValidate: {
        ...
        selectedCategory:
          (this.book &&
            ...
            this.book.categories.length &&
            this.book.categories[0].id + '') ||
          '',
      ...
      ruleInline: {
        ...
        readLimits: [{ required: true, message: '' }],
        contentType: [{ required: true, message: '' }],
        content: [
