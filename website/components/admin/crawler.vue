<template>
  <Row>
    ...
    >
      ...
      <template v-if="isCustom && formData.scope === 'list'">
        <FormItem label="列表项选择器" prop="listItemSelector">
          <Row>
            <Col span="12">
              <Input
                v-model="formData.listItemSelector"
                placeholder="请输入列表项选择器"
              ></Input>
            </Col>
          </Row>
        </FormItem>
        ...
        <FormItem label="列表项标题选择器" prop="listItemTitleSelector">
          <Row>
            <Col span="12">
              <Input
                v-model="formData.listItemTitleSelector"
                placeholder="请输入列表项标题选择器"
              ></Input>
            </Col>
          </Row>
        </FormItem>
      ...
      <FormItem
        :key="i"
        v-for="(article, i) in formData.articles"
        label="URL"
        :prop="'articles.' + i + '.url'"
        :rules="urlValidate"
      >
      ...
      <FormItem>
        <Row>
          <Col span="4">
            <Button type="dashed" long @click="onAdd" icon="plus-round"
              >添加URL</Button
            >
          </Col>
        </Row>
