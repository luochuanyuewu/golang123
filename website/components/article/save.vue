  ...
  <div class="topic-box">
    <div class="topic-main">
      <ul class="topic-nav">
        ...
        <li>
          <span class="publish-label">{{ id ? '编辑' : '发布' }}话题</span>
        </li>
      </ul>
        ...
        <div class="topic-area">
          ...
          >
            ...
            <Form-item class="topic-content" :label-width="0" prop="content">
              <html-editor
                v-if="article && article.contentType == 2"
    ...
    <ul class="topic-sidebar">
      <li class="topic-sidebar-item">
        ...
        <p>
          <a
            href="https://www.golang123.com/book/30"
            style="color: #08c;"
            target="_blank"
            >Markdown参考文档</a
          >
      ...
      <li class="topic-sidebar-item">
        ...
        <p
          v-if="hasRecentArticles"
          v-for="(article, i) in recentArticles"
          class="topic-sidebar-my"
          :style="{ 'border-top': i == 0 ? 'none;' : '1px solid #f0f0f0;' }"
        >
          <a :href="'/topic/' + article.id" target="_blank">{{
            article.name
          }}</a>
        </p>
  ...
  data() {
    return {
      ...
      formValidate: {
        ...
        content:
          (this.article &&
            (this.article.content || this.article.htmlContent)) ||
          ''
      },
      ruleInline: {
        topicName: [
